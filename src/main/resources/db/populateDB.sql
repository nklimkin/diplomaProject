...
INSERT INTO USERS (NAME, SURNAME, EMAIL, PASSWORD)
    VALUES ('user1', 'user1_surName', 'user1@email.ru', '{noop}user1_pass'),
           ('user2', 'user2_surName', 'user2@email.ru', '{noop}user2_pass'),
           ('admin1', 'admin1_surName', 'admin1@email.ru', '{noop}admin1_pass');
